...
effect_11 = function(kine_data, x) {
  ...
  # Step 0: 
  mod11 = lm(Y1_1 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((Y1_1) + (M1_1 + M2_1 + M3_1)) , data = kine_data) # First block: baseline confounder, Second block: M1, Third block: L1
  kine_data$a0 = predict(mod11, newdata = kine_data_cp)
  
  # Step 1: 
  ## j = 1 : M0 and L0 == null 
  ### 1.1
  mod_b1 = lm(a0 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) +  ((M1_1 + M2_1 + M3_1)) , data = kine_data) # M0 = Null , L1
...
effect_12 = function(kine_data, x) {
  ...
  # Step 0: 
  mod12 = lm(Y1_2 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((Y1_2) + ( Y2_1 + M1_2 + M2_2 + M3_2)) , data = kine_data) # First block: baseline conFounders, Second block: M2, Third block: L2, does not include M3_1 because L excludes M(at -1) based on figure 2 description
  kine_data$a0 = predict(mod12, newdata = kine_data_cp)
  
  # Step 1: 
  ## j = 1 : M0 and L0 == null 
  ### 1.1
  mod_b1 = lm(a0 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) +  ((Y1_2) + (Y2_1 + M1_2 + M2_2 + M3_2)) , data = kine_data) #M1 , L2
  kine_data_cp$Group= xst
  kine_data$b1 = predict(mod_b1, newdata = kine_data_cp)
  ### 1.2
  mod_a1 = lm(b1 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((Y1_2) + (M1_1 + M2_1 + M3_1)) , data = kine_data) #M1, L1
  kine_data_cp$Group= x
  kine_data$a1 = predict(mod_a1, newdata = kine_data_cp)
  
  ## j = 2
  ### 1.1
  mod_b2 = lm(a1 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + (M1_1 + M2_1 + M3_1), data = kine_data) # M0, L1
  kine_data_cp$Group= xst
...
```{r}
#Y13
effect_13 = function(kine_data, x) {
  x = x
  xst = 1 - x
  kine_data_cp = kine_data # Use all observations 
  kine_data_cp$Group= x
  ...
  # Step 0: 
  mod13 = lm(Y1_3 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ( (Y1_3) + (Y2_2 + M1_3 + M2_3 + M3_3)) , data = kine_data) # First block: baseline conFounders, Second block: M3, Third block: L3, does not include M3_2 because L excludes M(at -1) based on figure 2 description
  kine_data$a0 = predict(mod13, newdata = kine_data_cp)
  
  # Step 1: 
  ## j = 1 : M0 and L0 == null 
  ### 1.1
  mod_b1 = lm(a0 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) +  ((Y1_2) + (Y2_2 + M1_3 + M2_3 + M3_3)) , data = kine_data) #M2 , L3
  kine_data_cp$Group= xst
  kine_data$b1 = predict(mod_b1, newdata = kine_data_cp)
  ### 1.2
  mod_a1 = lm(b1 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((Y1_2) + (Y2_1 + M1_2 + M2_2 + M3_2)) , data = kine_data) #M2, L2
  kine_data_cp$Group= x
  kine_data$a1 = predict(mod_a1, newdata = kine_data_cp)
  
  ## j = 2
  ### 1.1
  mod_b2 = lm(a1 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((Y1_1) + (Y2_1 + M1_2 + M2_2 + M3_2)), data = kine_data) # M1, L2
  kine_data_cp$Group= xst
  kine_data$b2 = predict(mod_b2, newdata = kine_data_cp)
  ### 1.2
  mod_a2 = lm(b2 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((Y1_1) +  (M1_1 + M2_1 + M3_1)) , data = kine_data) # M1, L1 
  kine_data_cp$Group= x
  kine_data$a2 = predict(mod_a2, newdata = kine_data_cp)
  
  ## j = 3
  ### 1.1
  mod_b3 = lm(a2 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((M1_1 + M2_1 + M3_1)), data = kine_data) # MO, L1
  kine_data_cp$Group= xst
...
effect_21 = function(kine_data, x) {
  ...
  # Step 0: 
  mod21 = lm(Y2_1 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((Y1_1) + (M1_1 + M2_1 + M3_1)) , data = kine_data) # First block: baseline confounder, Second block: M1, Third block: L1
...
effect_22 = function(kine_data, x) {
  ...
  # Step 0: 
  mod22 = lm(Y2_2 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ((Y1_2) + ( Y2_1 + M1_2 + M2_2 + M3_2)) , data = kine_data) # First block: baseline conFounders, Second block: M2, Third block: L2, does not include M3_1 because L excludes M(at -1) based on figure 2 description
...
```{r}
#Y23
effect_23 = function(kine_data, x) {
  x = x
  xst = 1 - x
  kine_data_cp = kine_data # Use all observations 
  kine_data_cp$Group= x
  ...
  # Step 0: 
  mod23 = lm(Y2_3 ~ Group + (Gender.f + Age + Y1_0 + Y2_0 + M1_0 + M2_0 + M3_0) + ( (Y1_3) + (Y2_2 + M1_3 + M2_3 + M3_3)) , data = kine_data) # First block: baseline conFounders, Second block: M3, Third block: L3, does not include M3_2 because L excludes M(at -1) based on figure 2 description
